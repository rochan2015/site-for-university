...
<form action="changedepartmentsecretary.php" method="post">
      <p>
        <label for="id">id_secretary:</label>
...
$id_secretary = mysqli_real_escape_string($link, $_REQUEST['id']);
$name = mysqli_real_escape_string($link, $_REQUEST['name']);
$age = mysqli_real_escape_string($link, $_REQUEST['age']);
$tele_number = mysqli_real_escape_string($link, $_REQUEST['tele_number']);
// Attempt insert query execution
if($id_secretary!=null && $name!=null && $age!=null && $tele_number!=null){
$sql = "INSERT INTO `department secretary` (id, name, age, tele_number) VALUES ('$id_secretary','$name', '$age', '$tele_number')";
...
if($id_secretary!=null){
$sql = "DELETE FROM `department secretary` WHERE id='$id_secretary'";
if(mysqli_query($link, $sql)){
...
if($id_secretary!=null && $name!=null && $age!=null && $tele_number!=null ){
$sql = "UPDATE `department secretary` SET name ='$name', age ='$age', tele_number ='$tele_number' WHERE id='$id_secretary'";
