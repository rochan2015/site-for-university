...
<form action="changedepatmentdirectory.php" method="post">
      <p>
        <label for="id">id_directory:</label>
...
$id_directory = mysqli_real_escape_string($link, $_REQUEST['id']);
$name = mysqli_real_escape_string($link, $_REQUEST['name']);
$age = mysqli_real_escape_string($link, $_REQUEST['age']);
$tele_number = mysqli_real_escape_string($link, $_REQUEST['tele_number']);
// Attempt insert query execution
if($id_directory!=null && $name!=null && $age!=null && $tele_number!=null){
$sql = "INSERT INTO `head of the department` (id, name, age, tele_number) VALUES ('$id_directory','$name', '$age', '$tele_number')";
...
$sql = "DELETE FROM `head of the department` WHERE id='$id_directory'";
if(mysqli_query($link, $sql)){
...
if($id_directory!=null && $name!=null && $age!=null && $tele_number!=null ){
$sql = "UPDATE `head of the department` SET name ='$name', age ='$age', tele_number ='$tele_number' WHERE id='$id_directory'";
